...
let agents = [agent_1, agent_2, agent_3, agent_4, agent_5, agent_6, agent_7, agent_8, agent_9, agent_10, agent_11]


//: ## Step 3
//: Create a function that calculates the total number of compromised agents. Inside the function, iterate over the array of agents to determine which ones are compromised. Return the total count.
func totalAgents(compromisedAgents: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)] ) -> Int {
    var numberOfCompromisedAgents = 0
    for agents in compromisedAgents {
...
var compromisedAgents = totalAgents(compromisedAgents: agents)
...
func findCleanAgent(_ namesOfUncompromisedAgents: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]) -> [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]{
    var uncompromisedAgents: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)] = []
    for agent in namesOfUncompromisedAgents {
...
var uncompromisedAgentsArray = findCleanAgent(agents)
print("\(uncompromisedAgentsArray.count) clean agents out of \(agents.count) total agents")
...
func findHighRisk(_ passingArrayOfAgents: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]) {
    for agent in passingArrayOfAgents {
...
func findLevelOfAgents (_ levelOfAgent: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]) {
    var agentLowLevel = 0
    var agentMidLevel = 0
    var agentHighLevel = 0
    for agent in levelOfAgent {
    ...
    print("\(agentLowLevel) low level agents, \(agentMidLevel) mid level agents, \(agentHighLevel) hight level agents")
}
